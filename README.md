...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-forest-1e44
```

A live public deployment of this template is available at [https://shrill-forest-1e44.templates.workers.dev](https://shrill-forest-1e44.templates.workers.dev)
